...
mod tests {
    ...
    macro_rules! tests_for { ($T:ty, $mod:ident) => { mod $mod {
        use crate::*;
    ...
    #[test]
    fn test_serialize_naive_list_set() {
        let set = crate::naive_list_set::NaiveListSet::from_iter([3, 1, 4]);
        let serialized = set.serialize();
        assert_eq!(serialized, "1, 3, 4");
        let deserialized = crate::naive_list_set::NaiveListSet::deserialize(&serialized);
        assert_eq!(set, deserialized);
    }

    #[test]
    fn test_serialize_hash_set_set() {
        let set = crate::hash_set_set::HashSetSet::from_iter([3, 1, 4]);
        let serialized = set.serialize();
        assert_eq!(serialized, "1, 3, 4");
        let deserialized = crate::hash_set_set::HashSetSet::deserialize(&serialized);
        assert_eq!(set, deserialized);
    }

    #[test]
    fn test_serialize_interval_set() {
        let set = crate::interval_set::IntervalSet::from_iter([1, 2, 5, 7, 8]);
        let serialized = set.serialize();
